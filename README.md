...
This makes the `/prd` and `/ralph` commands available in all your projects.
...
Frontend stories must include browser verification in acceptance criteria. Ralph will use available browser/screenshot tools to navigate to the page, interact with the UI, and confirm changes work.
